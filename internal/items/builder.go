...
func buildLogoutItem(cfg LogoutCfg) Item {
	return Item{Enable: true, Icon: cfg.Icon, Label: logoutLabel, Cmd: cfg.Cmd}
}

func buildLockItem(cfg LockCfg) Item {
	return Item{Enable: true, Icon: cfg.Icon, Label: lockLabel, Cmd: cfg.Cmd}
}

func buildSuspendItem(cfg SuspendCfg) Item {
	return Item{Enable: true, Icon: cfg.Icon, Label: suspendLabel, Cmd: cfg.Cmd}
}

func buildHibernateItem(cfg HibernateCfg) Item {
	return Item{Enable: true, Icon: cfg.Icon, Label: hibernateLabel, Cmd: cfg.Cmd}
}
